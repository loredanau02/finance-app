...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 9:
                    if (isLoggedIn) {
                        addInformationToTicket();
                    } else {
                        System.out.println("Please log in to add information to your tickets.");
                    }
                    break;
                case 10:
                    if (isLoggedIn) {
                ...
                case 14:
                    if(isSupportPerson()) {
                        ...
                        System.out.printIn("Unauthorised access.")
                     }
                    break;
                case 15:
    ...
    private static void displayMenu() {
        ...
        System.out.println("9. Add Information to Ticket");
        ...
        if (isLoggedIn && isSupportPerson()) {
            System.out.println("14. View All Support Tickets");
        }
    ...
    private static void viewSupportTickets() {
        System.out.println("\n=== View All Support Tickets ===");
        supportCentreManager.viewAllTickets();
    }
    ...
    private static void addInformationToTicket() {
        ...
        if (supportCentreManager.addInformationToTicket(ticketId, additionalInfo)) {
